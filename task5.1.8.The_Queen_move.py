...
while True:
    ...
    if y1.isdigit() and 1 <= int(y1) <= 8:
        ...
        print()
while True:
    x2 = input('Введи первую координату клетки, куда ферзь должен пойти: ')
    if x2.isdigit() and 1 <= int(x2) <= 8:
        ...
        print()
while True:
    y2 = input('Введи вторую координату клетки, куда ферзь должен пойти: ')
...
if abs(x2 - x1) == -3 and y2 == y1:
    print(f"Ферзь с клетки с кооринатами ({x1};{y1}) может пойти на клетку с координатами ({x2};{y2})")
