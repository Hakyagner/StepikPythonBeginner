...
print()
print(f"Стоимость 1 монитора: {monitor_price};")
print(f"Стоимость 1 системного блока: {block_price};")
print(f"Стоимость 1 клавиатуры: {keyboard_price};")
print(f"Стоимость 1 мыши: {mouse_price};")
print(f"Стоимость 3 компьютеров: {computer3};")
