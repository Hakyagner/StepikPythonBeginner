...
if abs(x2 - x1) % 2 == 0:
    if abs(y2 - y1) % 2 == 0:
        print(f"Координата первой клетки и координата второй клетки одного и того же цвета.")
    else:
        print(f"Координата первой клетки и координата второй клетки не одного и того же цвета.")
else:
    if abs(y2 - y1) % 2 == 0:
        print(f"Координата первой клетки и координата второй клетки не одного и того же цвета.")
    else:
