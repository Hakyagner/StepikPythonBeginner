...
if abs(x2 - x1) % 2 == 0:
    if abs(y2 - y1) % 2 == 0:
        print(f"Координата первой клетки и координата второй клетки имеет один и тот же цвет.")
    else:
        print(f"Координата первой клетки и координата второй клетки не имеет один и тот же цвет.")
else:
    if abs(y2 - y1) % 2 == 0:
        print(f"Координата первой клетки и координата второй клетки не имеет один и тот же цвет.")
    else:
