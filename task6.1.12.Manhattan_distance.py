...
print(f"Манхэттенское расстояние между двумя точками с координатами ({p1}, {p2}), ({q1}, {q2}) равно {abs(p1 - q1) + abs(p2 - q2)}.")

# неправильно. При вводе какого-то числа появляется ошибка
