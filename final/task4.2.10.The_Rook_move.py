...
if x2 == x1 or y2 == y1:
    print(f"Ладья с клетки с кооринатами ({x1};{y1}) может пойти на клетку с координатами ({x2};{y2})")
else:
    print(f"Ладья с клетки с кооринатами ({x1};{y1}) не может пойти на клетку с координатами ({x2};{y2})")
